...
class RoboFile extends \Robo\Tasks
{
    ...
    public function demoRemove(): void
    {
        $this->_remove([
            ...
            __DIR__ . '/src/Resources/config/api-platform/DemoEntity.yaml',
            __DIR__ . '/src/Resources/config/doctrine/DemoEntity.orm.xml',
            __DIR__ . '/src/Resources/config/serialization/DemoEntity.yaml',
            __DIR__ . '/src/Resources/config/validator/DemoEntity.yaml',
